...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    keywords: ['Phantom Blade Zero Wiki', 'Phantom Blade Zero about', 'Phantom Blade Zero community wiki', 'Phantom Blade Zero fan wiki', 'Phantom Blade Zero Kungfupunk ARPG'],
  };
}
